...
import "../css/tareaAgregadaMod.css";

function TareaAgregadaMod(props) {
  ...
  return (
    <div className={props.validar ? 'contModalAgregarTareaActive' : 'contModalAgregarTarea'}>
      ...
      <textarea className='contModalAgregarTarea__Texta' onChange={(e) => CalcularCaracteres(e)} cols="30" rows="10" placeholder='Empiece a escribir'>
...
export default TareaAgregadaMod;